...
<section id="main" class="content col-xs-12">
	...
	<div class="window row" data-delay="0" data-animation="fade-in">    
		<?php query_posts( array ( 'category_name' => 'work', 'posts_per_page' => 9 ) ); ?>
		...
		<?php wp_reset_query(); ?>
		<div class="more">
			<h5><a href="<?php echo esc_url( get_permalink( get_page_by_title('work'))); ?>">See More Work</a></h5>
		</div>

	</div>
	<div class="reach" data-delay="0" data-animation="fade-in">
		<h4>Ready to stand out?<div class="button"><a href="<?php echo esc_url( get_permalink( get_page_by_title('contact'))); ?>">Get in touch</a></div></h4>
	</div>
<div class="clearfix"></div>
