...
function skylarwuebker2_setup() {
	 ...
	 * If you're building a theme based on SkylarWuebker2, use a find and replace
	 * to change 'skylarwuebker2' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'skylarwuebker2', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'skylarwuebker2' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'skylarwuebker2_custom_background_args', array(
 ...
 */
function skylarwuebker2_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'skylarwuebker2' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'widgets_init', 'skylarwuebker2_widgets_init' );
